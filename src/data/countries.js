/* ── Country calling codes ──────────────────────────────────────
   Covers UN member states. Used by the phone input's country
   dropdown. Flags are rendered from the iso2 code at display time
   (see flagEmoji), no image assets needed. */
...
/* Regional indicator symbols — renders a flag emoji from an iso2
   code with no image assets or API calls. */
